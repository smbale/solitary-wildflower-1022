...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/solitary-wildflower-1022
```

A live public deployment of this template is available at [https://solitary-wildflower-1022.templates.workers.dev](https://solitary-wildflower-1022.templates.workers.dev)
